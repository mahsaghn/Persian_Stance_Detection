...
class FeatureExtractorConf:
  ...
  part_name: str = 'parts'
  w2v_model_path: str = '/home/mahsa/Desktop/final_project/stance_detection/stance_detection/dataset/cc.fa.300.vec'
  save_load_path: str = ''
...
class H2CBaselineConfig:
  ...
  load_path: str = '/home/mahsa/Desktop/final_project/stance_detection/stance_detection/dataset/seperated'
  load_if_exist: bool = False
  test_size: float = 0.2
